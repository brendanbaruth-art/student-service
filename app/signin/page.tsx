  ...
  return (
    <PageShell>
      <section className="mx-auto grid min-h-[70vh] max-w-6xl items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_420px] lg:px-8">
        ...
        <form className="rounded-lg border border-[#E5E7EB] bg-white p-6 shadow-[0_18px_35px_rgba(21,34,56,0.06)]">
          ...
          <p className="mt-4 text-center text-sm text-[#667085]">
            New to Etudo? <a href="/signup" className="font900 text-[#5B7CFA]">Get started</a>
          </p>
        </form>
      </section>
    </PageShell>
